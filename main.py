...
def mCrearBaraja():
    ...
    titulo = "BARAJA NUEVA"
    mensaje =""
    link1 = "window.location.href='http://127.0.0.1:8000/deck/new'"
    link2 = "window.location.href='http://127.0.0.1:8000/deck/shuffle'"
    link3 = "window.location.href='http://127.0.0.1:8000/deck/show/remain'"
    link4 = "window.location.href='http://127.0.0.1:8000/deck/pickone'"
    link5 = "window.location.href='http://127.0.0.1:8000/user/show/hand'"
    link6 = "window.location.href='http://127.0.0.1:8000/user/play'"
    link7 = "window.location.href='http://127.0.0.1:8000'"
